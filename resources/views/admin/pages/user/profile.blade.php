 ...
 @section('content')
     ...
     <div class="container-fluid">
         ...
         <div class="row">
             <div class="col-md-12">
                 <form method="post" action="https://material-dashboard-laravel.creative-tim.com/profile" autocomplete="off"
                     class="form-horizontal">
                     <input type="hidden" name="_token" value="2135U7L0SyXaFJQ2U6L5BkL5wtwSbC4t1KBOEf3B"> <input
                                 ...
                                 <div class="col-sm-7">
                                     <div class="form-group bmd-form-group is-filled">
                                         <input class="form-control" name="name" id="input-name" type="text"
                                             placeholder="Name" value="Admin Admin" required="true" aria-required="true">
                                     </div>
                                 </div>
                             </div>
                             <div class="row">
                                 ...
                                 <div class="col-sm-7">
                                     <div class="form-group bmd-form-group is-filled">
                                         <input class="form-control" name="email" id="input-email" type="email"
                                             placeholder="Email" value="admin@material.com" required="">
                                     </div>
                                 </div>
                             </div>
                         </div>
         ...
         <div class="row">
             <div class="col-md-12">
                 <form method="post" action="https://material-dashboard-laravel.creative-tim.com/profile/password"
                     class="form-horizontal">
                     <input type="hidden" name="_token" value="2135U7L0SyXaFJQ2U6L5BkL5wtwSbC4t1KBOEf3B"> <input
                         type="hidden" name="_method" value="put">
                     <div class="card">
