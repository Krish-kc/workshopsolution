        ...
        <div class="card-body">
            ...
            <form action="{{route('slot.store')}}" method="POST"
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="slot_duration" class="form-control @error('slot_duration') is-invalid @enderror"
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="time" name="slot_start_time" class="form-control @error('slot_start_time') is-invalid @enderror"
                                placeholder="please Enter the PAN number">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="time" name="slot_end_time" class="form-control @error('slot_end_time') is-invalid @enderror"
                                placeholder="please Enter the PAN number">
                            @error('slot_end_time')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="time" name="slot_break_time" class="form-control @error('slot_break_time') is-invalid @enderror"
                                placeholder="please Enter the PAN number">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="slot_break_duration" class="form-control @error('slot_break_duration') is-invalid @enderror"
                                placeholder="please Enter the PAN number">
